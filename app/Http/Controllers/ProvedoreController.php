...
class ProvedoreController extends AdminBaseController
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.configuracion.provedor.index',compact('provedores'));
    }
    ...
    {
        return view('admin.configuracion.provedor.create');
    }
...
/*
        ...
        return view('admin.configuracion.provedor.edit',['provedore'=>$provedore]);*/
    }
