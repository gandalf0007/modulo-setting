...
<div class="form-group form-md-line-input has-success">
    ...
    <div class="input-group">
       <span class="input-group-btn">
        ...
        <input type="text" name="private_key" class="form-control"  placeholder="Ingrese la Key">
     </div>
</div>
...
<div class="form-group form-md-line-input has-success">
    ...
    <div class="input-group">
       <span class="input-group-btn">
          ...
          <input type="text" class="form-control" name="public_key" placeholder="Ingrese la Key">
     </div>
</div>
